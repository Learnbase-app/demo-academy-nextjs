...
function ProgressIndicator({
  ...
  return (
    <ProgressPrimitive.Indicator
      ...
      className={cn(
        "h-full rounded-full bg-[linear-gradient(90deg,color-mix(in_oklab,var(--primary)_88%,white_12%),color-mix(in_oklab,var(--foreground)_10%,var(--primary)_90%))] transition-all",
        className
      )}
      {...props}
    />
